            ...
            <div className="glass-card p-10 h-full relative">
              ...
              <div className="relative w-full h-64 rounded-xl overflow-hidden mb-8">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  <h2 className="font-bold text-2xl sm:text-3xl text-center mb-4 font-heading">Готовы начать свой финансовый путь с ЮНИК?</h2>
                  <p className="text-white/90 mb-4 text-center text-base sm:text-lg">
